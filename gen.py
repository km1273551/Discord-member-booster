...
try:
    ...
    os.system('pip install turtle && cls')
    from turtle import update
...
try:
    ...
    os.system('pip install websocket && cls')
    import websocket
...
try:
    ...
    os.system('pip install base64 && cls')
    import base64

try:
    import httpx
except:
    os.system('pip install httpx && cls')
    import httpx
...
try:
    os.system('title Member Boost by nyax44')
except:
    pass
    ...
    while True:
        try:
            ...
            with httpx.Client(cookies={"locale": "en-US"}, headers={"Accept": "*/*", "Accept-Language": "en-US", "Connection": "keep-alive", "Content-Type": "application/json", "DNT": "1", "Host": "discord.com", "Referer": f"https://discord.com/invite/{invite}", "Sec-Fetch-Dest": "empty", "Sec-Fetch-Mode": "cors", "Sec-Fetch-Site": "same-origin", "TE": "trailers", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36", "X-Track": ""}, proxies=proxies) as client:
                ...
                client.headers["X-Super-Properties"] = f"{os.urandom(580).hex()}"
...
def main():
  ...
  {Fore.WHITE}╚═════╝ ╚══════╝╚═╝  ╚═╝╚══════╝   ╚═╝    ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚═════╝ {Fore.WHITE}
                ...
                ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
                ┃{Fore.WHITE}          github.com/nyax44{Fore.MAGENTA}                ┃
